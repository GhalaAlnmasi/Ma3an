"""
Django settings for Ma3an project.
...
SECRET_KEY = 'django-insecure-bj*b)lr%df*2d@3l*99bj+@!tw+iirqj7u#%ye_wmz(#*w9cpk'
...
WSGI_APPLICATION = 'Ma3an.wsgi.application'
